---
{"dg-publish":true,"permalink":"/gardening/how-to-connect-zotero-7-to-obsidian-mac-os/","created":"2024-09-30T09:11:48.000+08:00","updated":"2025-02-11T16:17:51.000+08:00"}
---
...
1. If you assigned a hotkey to create a Reading Note, use it now. Otherwise, you can always pen the Command Palette by pressing 'Cmd + P' on Mac then search for the plugin's commands (you set this up in the options earlier. In this case, it is '📖 Reading Note'). Clicking on it will bring up a search bar for Zotero. Look for the reference you need and select it to create your Reading Note.
